...
//@line 10 "c:\Temp\grifsrc\mozilla-2.0\toolkit\content\WindowDraggingUtils.jsm"
...
//@line 17 "c:\Temp\grifsrc\mozilla-2.0\toolkit\content\WindowDraggingUtils.jsm"
  if (!this.isPanel())
    this._elem.addEventListener("MozMouseHittest", this, false);
  else
//@line 21 "c:\Temp\grifsrc\mozilla-2.0\toolkit\content\WindowDraggingUtils.jsm"
...
//@line 64 "c:\Temp\grifsrc\mozilla-2.0\toolkit\content\WindowDraggingUtils.jsm"
    if (!isPanel) {
      if (this.shouldDrag(aEvent))
        aEvent.preventDefault();
      return;
    }
//@line 70 "c:\Temp\grifsrc\mozilla-2.0\toolkit\content\WindowDraggingUtils.jsm"
...
//@line 81 "c:\Temp\grifsrc\mozilla-2.0\toolkit\content\WindowDraggingUtils.jsm"
        if (isPanel) {
...
//@line 94 "c:\Temp\grifsrc\mozilla-2.0\toolkit\content\WindowDraggingUtils.jsm"
        break;
      case "mousemove":
